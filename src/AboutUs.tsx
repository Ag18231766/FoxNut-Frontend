        ...
        <div>
            <div className="flex justify-center">
                <div className="h-full w-7xl mt-6 mb-10 bg-gray-100 ">
                    <div className="flex justify-center">
                        <div className="text-4xl lg:text-6xl pt-5 mb-5 text-gray-600">About FOXNAMI</div>
                    </div>
                    <div className="text-3xl text-center mt-16 mb-12  text-gray-600">Who We Are</div>
                    ...
                    <div className="text-3xl text-center mt-16 mb-12  text-gray-600">Building A Healthier Future</div>
