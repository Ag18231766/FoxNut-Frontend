...
export default function Privacy() {
    ...
    const [Content] = useState<ContentInterface[]>([
        {   key:1,
            title: "Who we are",
            content: "Our website address is https://indianfoxnut.com. This website is managed by Sigmate Enterprises with head office based in 404, whistling winds, wagh nagar, Pisoli, Pune, Maharashtra, 411048, India"
        },
        {   key:2,
            title: "Comments",
            ...
            <div className="h-full">
                <div className="flex justify-center">
                    <div className="w-7xl bg-gray-100">
                        <div className="flex justify-center"><div className="text-6xl mt-7">Privacy Policy</div></div>
                        {Content.map((item) => (
