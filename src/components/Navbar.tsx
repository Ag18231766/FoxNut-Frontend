        ...
        <div>
          <header className="flex justify-between items-end text-gray-50 py-6 px-8 md:px-32 bg-white drop-shadow-sm">
              ...
              <ul className="hidden lg:flex items-center gap-12 font-semibold text-gray-600">
                  ...
                  <li className="p-3 hover:bg-gray-100 hover:text-gray-400 rounded-md transition-all cursor-pointer">About <span ><i className='bx bxs-chevron-down'></i></span></li>
                  <li className="p-3 hover:bg-gray-100 hover:text-gray-400 rounded-md transition-all cursor-pointer">Contacts</li>
              </ul>
              ...
              >
                ...
                <li className="list-none w-full text-center p-4 hover::bg-gray-400 hover:text-gray-400 transition-all cursor-pointer text-gray-600">About</li>
                <li className="list-none w-full text-center p-4 hover::bg-gray-400 hover:text-gray-400 transition-all cursor-pointer text-gray-600">Contacts</li>
              </div>
          </header>
      </div>
